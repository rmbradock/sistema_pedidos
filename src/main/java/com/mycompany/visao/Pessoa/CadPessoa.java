...
//            tfIdEndereco.setText(String.valueOf(daoEndereco.buscarProximoId()));          
    ...
    private void initComponents() {
        ...
        pfSenha.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorMoved(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorRemoved(javax.swing.event.AncestorEvent evt) {
                pfSenhaAncestorRemoved(evt);
            }
        });
        ...
        jLabel18.setText("ID Endereco");

        jLabel19.setText("ID Endereco");

        jLabel20.setText("ID Cidade");
    ...
    private void pfSenhaAncestorRemoved(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_pfSenhaAncestorRemoved
        // TODO add your handling code here:
    }//GEN-LAST:event_pfSenhaAncestorRemoved
